...
export async function acceptFriendRequest(req, res) {
  try {
    ...
    const friendRequest = await FriendRequest.findById(requestId); // searches for the friendRequest doc
...
export async function getFriendRequest(req, res) {
    try {
        //Requests sent to you but not accepted yet.
        const incomingReqs = await FriendRequest.find({ 
            recipient: req.user.id, // gets from the middleware
            status: "pending",
